package io.codetail.animation.arcanimator.arcanimator;
...
class ArcMetric {
    ...
    /**
     * Create new {@link io.codetail.animation.arcanimator.ArcMetric} instance and do all calculations below
